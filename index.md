...
to lists and handled the same way.
...
no per-process memory allocation. A data frame with 10 columns lives in
a single shared region; a task that touches 3 columns pays for 3.
