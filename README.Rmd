...
vectors, etc.) — and data frame columns are written directly into
shared memory. Pairlists are coerced to lists and handled the same way.
...
closures, language objects) are returned unchanged by `sora()`.
