...
[`share()`](https://shikokuchuo.net/mori/dev/reference/share.md) calls
...
- `test-api.R` —
  [`share()`](https://shikokuchuo.net/mori/dev/reference/share.md)/[`map_shared()`](https://shikokuchuo.net/mori/dev/reference/map_shared.md)/[`shared_name()`](https://shikokuchuo.net/mori/dev/reference/shared_name.md)/[`is_shared()`](https://shikokuchuo.net/mori/dev/reference/is_shared.md)
